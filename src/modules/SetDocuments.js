...
var SetDocuments = {
  ...
  setDocument : async function (obj) {
    ...
    try {
      ...
      logger.error("Erreur dans la création du document :", error);
  ...
  updateGeometryDocument : async function (obj) {
    ...
    try {
      ...
      logger.error("Erreur dans la mise à jour de la géométrie du document :", error);
      this.throwError(error);
    }
  },
  ...
  updateMetadataDocument : async function (obj) {
    ...
    try {
      ...
      logger.error("Erreur dans la mise à jour des métadonnées du document :", error);
      this.throwError(error);
    }
  },
  ...
  sharingDocument : async function (obj) {
    ...
    try {
      ...
      logger.error("Erreur dans le partage du document :", error);
      this.throwError(error);
    }
  },
  ...
  renameDocument : async function (obj) {
    ...
    try {
      ...
      logger.error("Erreur dans la mise à jour du nom du document :", error);
      this.throwError(error);
    }
  },
  ...
  deleteDocument : async function (obj) {
    ...
    try {
      ...
      logger.error("Erreur dans la suppression du document :", error);
      this.throwError(error);
    }
  },
